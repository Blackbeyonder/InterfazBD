...
jTextField4Telefono.setText(null);
    ...
    public TablaApicultores() {
        ...
        String sql ="SELECT idApicultor, Nombre_Api, Municipio_Api,Telefono_Api From mielprime.apicultores";
...
if(!"".equals(campo))
{
 ...
 DefaultTableModel modelo = new DefaultTableModel();
       ...
       PreparedStatement ps= null;
        ...
        String sql ="SELECT idApicultor, Nombre_Api, Municipio_Api,Telefono_Api From mielprime.apicultores"+where;
        System.out.println(sql);
        ps = con.prepareStatement(sql);
        rs= ps.executeQuery();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       PreparedStatement ps= null;
        ...
        ps=con.prepareStatement("SELECT idApicultor, Nombre_Api, Municipio_Api,Telefono_Api From mielprime.apicultores WHERE idApicultor=?");
        //System.out.println(sql);
    ...
    private void jButton1ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ModificarActionPerformed
      ...
      PreparedStatement ps= null;
        ...
        ps=con.prepareStatement("UPDATE mielprime.apicultores SET Nombre_Api=?,Municipio_Api=?,Telefono_Api=? WHERE idApicultor=?");
        //System.out.println(sql);
