...
jTextField1Telefono.setText(null);
    ...
    public TablaEmpleados() {
        ...
        String sql ="SELECT fk_TAMBOR_idTAMBOR, Nombre_Emp, Municipio_Emp, Telefono_Emp, Salario_Emp From mielprime.empleados";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 422, 146));
        ...
        getContentPane().add(jTextField2Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 110, 139, -1));
...
if(!"".equals(campo))
{
      where =" WHERE fk_TAMBOR_idTAMBOR='"+ campo+" '";
 ...
 DefaultTableModel modelo = new DefaultTableModel();
       ...
       PreparedStatement ps= null;
        ...
        String sql ="SELECT fk_TAMBOR_idTAMBOR, Nombre_Emp, Municipio_Emp,Telefono_Emp,Salario_Emp From mielprime.empleados"+where;
        System.out.println(sql);
        ps = con.prepareStatement(sql);
        rs= ps.executeQuery();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       PreparedStatement ps= null;
        ...
        ps=con.prepareStatement("SELECT fk_TAMBOR_idTAMBOR, Nombre_Emp, Municipio_Emp,Telefono_Emp,Salario_Emp From mielprime.empleados WHERE fk_TAMBOR_idTAMBOR=?");
        //System.out.println(sql);
        ps.setString(1,codigo);
        rs= ps.executeQuery();
        
        while(rs.next()){
        jTextFieldIdTambor.setText(rs.getString("fk_TAMBOR_idTAMBOR"));
    ...
    private void jButton1ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ModificarActionPerformed
      ...
      PreparedStatement ps= null;
        ...
        ps=con.prepareStatement("UPDATE mielprime.empleados SET Nombre_Emp=?,Municipio_Emp=?,Telefono_Emp=?,Salario_Emp=? WHERE fk_TAMBOR_idTAMBOR=?");
        //System.out.println(sql);
    ...
    private void jButton2BorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2BorrarActionPerformed
        ...
        ps=con.prepareStatement("DELETE FROM mielprime.empleados WHERE fk_TAMBOR_idTAMBOR=?");
        //System.out.println(sql);
