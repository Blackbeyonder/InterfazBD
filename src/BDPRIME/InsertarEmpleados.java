...
jTextField1Nombre2.setText(null); 
 ...
 jTextField1PrecioCent.setText(null);
    ...
    public InsertarEmpleados() {
        ...
        String sql ="SELECT idTAMBOR From tambor";
    ...
    private void initComponents() {
        ...
        jTextFieldNtambor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldNtamborKeyTyped(evt);
            }
        });
        ...
        getContentPane().add(jTextField3Municipio, new org.netbeans.lib.awtextra.AbsoluteConstraints(247, 168, 100, -1));
...
if(!"".equals(campo))
{
 ...
 DefaultTableModel modelo = new DefaultTableModel();
       ...
       PreparedStatement ps= null;
        ...
        String sql ="SELECT idTAMBOR From tambor"+where;
        System.out.println(sql);
        ps = con.prepareStatement(sql);
        rs= ps.executeQuery();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       PreparedStatement ps= null;
        ...
        ps=con.prepareStatement("SELECT idTAMBOR From tambor WHERE idTAMBOR=?");
        //System.out.println(sql);
    ...
    //Connection con= null;
        ...
        ps= con.prepareStatement("INSERT INTO empleados(fk_idTAMBOR, Nombre_Emp, Municipio_Emp,Telefono_Emp,Salario_Emp) VALUES(?,?,?,?,?)");
...
JOptionPane.showMessageDialog(null,"Poner solo numeros", "Error",JOptionPane.ERROR_MESSAGE);
    ...
    private void jTextFieldNtamborKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldNtamborKeyTyped
        char validar=evt.getKeyChar();
...
JOptionPane.showMessageDialog(null,"Poner solo numeros", "Error",JOptionPane.ERROR_MESSAGE);
    ...
    }//GEN-LAST:event_jTextFieldNtamborKeyTyped
