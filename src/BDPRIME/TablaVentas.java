...
jTextField4Precio.setText(null);
    ...
    public TablaVentas() {
        ...
        String sql ="SELECT idVENTAS,fk_idProducto,VFecha,VPrecio FROM venta";
    ...
    private void initComponents() {
        ...
        jTextFieldIdNTambor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldIdNTamborKeyTyped(evt);
            }
        });
        ...
        jTextField4Precio.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextField4PrecioKeyTyped(evt);
            }
        });
        ...
        jTextFieldIdVentas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldIdVentasKeyTyped(evt);
            }
        });
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 680, 320));
...
if(!"".equals(campo))
{
 ...
 DefaultTableModel modelo = new DefaultTableModel();
       ...
       PreparedStatement ps= null;
        ...
        String sql ="SELECT idVENTAS, fk_idProducto,VFecha,VPrecio From venta"+where;
        System.out.println(sql);
        ps = con.prepareStatement(sql);
        rs= ps.executeQuery();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       PreparedStatement ps= null;
        ...
        ps=con.prepareStatement("SELECT idVENTAS, fk_idProducto,VFecha,VPrecio From venta WHERE idVENTAS=?");
        //System.out.println(sql);
        ...
        jTextFieldIdNTambor.setText(rs.getString("fk_idProducto"));
    ...
    private void jButton1InsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1InsertarActionPerformed
      InsertarVentas uno = new InsertarVentas();
       uno.setLocationRelativeTo(null);
       uno.setSize(440, 330);
       uno.setVisible(true);
       uno.setTitle("Insertar ventas");
    ...
    private void jButton1ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ModificarActionPerformed
      ...
      PreparedStatement ps= null;
        ...
        ps=con.prepareStatement("UPDATE venta SET fk_idProducto=?,VFecha=?,VPrecio=? WHERE idVENTAS=?");
    ...
    private void jButton2BorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2BorrarActionPerformed
        ...
        ps=con.prepareStatement("DELETE FROM venta WHERE idVENTAS=? ");
        //System.out.println(sql);
...
JOptionPane.showMessageDialog(null,"Poner solo numeros", "Error",JOptionPane.ERROR_MESSAGE);
    ...
    private void jTextFieldIdVentasKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldIdVentasKeyTyped
        char validar=evt.getKeyChar();
...
JOptionPane.showMessageDialog(null,"Poner solo numeros", "Error",JOptionPane.ERROR_MESSAGE);
    ...
    }//GEN-LAST:event_jTextFieldIdVentasKeyTyped

    private void jTextFieldIdNTamborKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldIdNTamborKeyTyped
      char validar=evt.getKeyChar();
...
JOptionPane.showMessageDialog(null,"Poner solo numeros", "Error",JOptionPane.ERROR_MESSAGE);
    ...
    }//GEN-LAST:event_jTextFieldIdNTamborKeyTyped

    private void jTextField4PrecioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField4PrecioKeyTyped
        char validar=evt.getKeyChar();
...
JOptionPane.showMessageDialog(null,"Poner solo numeros", "Error",JOptionPane.ERROR_MESSAGE);
    ...
    }//GEN-LAST:event_jTextField4PrecioKeyTyped
